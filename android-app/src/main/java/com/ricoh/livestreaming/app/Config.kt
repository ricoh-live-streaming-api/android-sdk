...
object Config {
    ...
    enum class IceServersProtocol(val position: Int, val type: com.ricoh.livestreaming.IceServersProtocol) {
        ALL(0, com.ricoh.livestreaming.IceServersProtocol.ALL),
        UDP(1, com.ricoh.livestreaming.IceServersProtocol.UDP),
        TCP(2, com.ricoh.livestreaming.IceServersProtocol.TCP),
        TLS(3, com.ricoh.livestreaming.IceServersProtocol.TLS),
    }
    ...
    private var iceServersProtocol = com.ricoh.livestreaming.IceServersProtocol.ALL
    private var iceServersProtocolPosition = IceServersProtocol.ALL.position
    ...
    fun load(context: Context) {
        ...
        this.iceServersProtocolPosition = preferences.getInt(KEY_ICE_SERVERS_PROTOCOL, DEFAULT_ICE_SERVERS_PROTOCOL.position)
    }
    ...
    fun getSelectedIceServersProtocol(): Int {
        return this.iceServersProtocolPosition
    }

    fun getIceServersProtocol(): com.ricoh.livestreaming.IceServersProtocol {
        return this.iceServersProtocol
    }

    fun setIceServersProtocol(context: Context, position: Int, iceServersProtocol: com.ricoh.livestreaming.IceServersProtocol) {
        this.iceServersProtocolPosition = position
        this.iceServersProtocol = iceServersProtocol
        this.saveInt(context, KEY_ICE_SERVERS_PROTOCOL, position)
    }
